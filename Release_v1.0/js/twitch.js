...
class TwitchIntegration {
    ...
    handleFirstTimeChatter(username, userId, tags) {
        ...
        // Trigger the greeting animation/state
        const greetingState = greetingsConfig.state || 'wave';
        
        // Show the greeting
        this.pet.showMessage(greetingMessage, greetingsConfig.duration || 5000);
        
        // Play greeting animation
        if (greetingState && this.pet.config.states[greetingState]) {
            this.pet.setState(greetingState, greetingsConfig.duration || 5000);
        }
